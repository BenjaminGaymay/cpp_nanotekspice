...
namespace nts {
	...
	public:
		C4069(const std::string name) : Component(name, "4069",  14)
		{
			...
			_pins.push_back(new PinOutput(4, _name, {{_name, 3}, {_name, 3}}, INVERTED));
			_pins.push_back(new Pin(5, _name));
			_pins.push_back(new PinOutput(6, _name, {{_name, 5}, {_name, 5}}, INVERTED));
			...
			_pins.push_back(new PinOutput(10, _name, {{_name, 11}, {_name, 11}}, INVERTED));
			_pins.push_back(new Pin(11, _name));
			_pins.push_back(new PinOutput(12, _name, {{_name, 13}, {_name, 13}}, INVERTED));
