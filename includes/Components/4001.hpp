...
namespace nts {
	...
	public:
		C4001(const std::string name) : Component(name, "4001",  14)
		{
			...
			_pins.push_back(new PinOutput(3, _name, {{_name, 1}, {_name, 2}}, NOR));
			_pins.push_back(new PinOutput(4, _name, {{_name, 5}, {_name, 6}}, NOR));
			...
			_pins.push_back(new PinOutput(10, _name, {{_name, 7}, {_name, 8}}, NOR));
			_pins.push_back(new PinOutput(11, _name, {{_name, 12}, {_name, 13}}, NOR));
